...
namespace core
{
  ...
  {
    log::debug << "core::CTaskManager::CTaskManager()" << log::endl;
  ...
  void CTaskManager::close(CTask* task)
  {
    ...
    log::debug << "core::CTaskManager::close(task)" << log::endl;
    //mTasks[task] = false;
    task->close();
  ...
  {
    log::debug << "core::CTaskManager::run(callback)" << log::endl;
  ...
  {
    log::debug << "core::CTask::CTask(callback)" << log::endl;
  ...
  CTask::~CTask()
  {
    log::debug << "core::CTask::~CTask() ["<< mId << "]" << log::endl;
